...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Medilife : Emergency</title>
...
<html>
<body>
<br><br><table align="center" cellpadding=10 style="margin: 0px auto;" >
<tr><th><h3><center><b>Ambulance</b></center></h3></th>
<th><h3><center><b>Contact</b></center></h3></th></tr>
 <?php
	while( $row=pg_fetch_array($result))
	{
		echo"<tr><td align=center><h3>".$row['name']."</h3></td>";
		echo"<td align=center><h3>".$row['no']."</h3></td>";
	}
?>
</table><br><br>
<body>
    ...
    <footer id="footer">
      ...
      <div class="footer-middle">
        <div class="container">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 	      ...
 	      <p>&copy; Copyright 2019 <a href="emergency.php">Medilife</a></p>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="footer-bottom">
        <div class="container">
          <div class="row">
     	   <div class="col-md-12">
              <p>Design & Developed By <a rel="nofollow" href="emergency.php">Medilife</a></p>
            </div>
          </div>
        </div>
      </div>
