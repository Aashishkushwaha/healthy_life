...
<!--                <li class="dropdown">
	...
	<center><h1>Appointment Details</h1></center>
		...
		<table>
    	<tr>
			<th>Name:</th><td> <label><?php echo $_GET['na'] ?></label></td></tr><tr>
			<th>Appointment Date:</th><td> <label><?php echo $_GET['date'] ?></label></td></tr><tr>
			<th>Appointment Time:</th><td> <label><?php echo $_GET['time'] ?></label></td></tr><tr>
			<th>Doctor:</th><td> <label><?php echo $_GET['doctor'] ?></label></td></tr><tr>
			<th>Department:</th><td> <label><?php echo $_GET['dept'] ?></label></td></tr><tr>
			<th>Subject:</th><td> <label><?php echo $_GET['sub'] ?></label></td></tr><tr>
			<th>Address:</th><td> <label>
			<?php
				$name = $_GET['doctor'];
				$sqlUserDetails = "select add from consultant where doc_name = '$name';";
		
				$res = pg_query($sqlUserDetails);
