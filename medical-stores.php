...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Medilife : Medical Stores</title>
...
//              include 'services_header.php';
    ...
    <section id="sliderArea">
          ...
          ?>
            	...
            	<br><br><br><br><h2>
   				<center>Near-By Medical Stores</center></h2>
                <div class="line"></div>
            <?php
            }
            else
            ...
            ?>
   				...
   				<br><br><br><br><h2>
   				<center>Medical Stores</center></h2>
                <div class="line"></div>
        	<?php
        	}
        	?>
...
//        var pyrmont = {lat: 18.509560, lng: 73.857270};
    //    var pyrmont = {lat , lng};
				...
				// 18.5243283,73.8595489

		//alert(pyrmont.lat);
		
		console.log("Lat: " + pyrmont);
    ...
    <footer id="footer">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="single-footer-widget">
                ...
                <ul class="tag-nav">
                  <li><a href="https://www.mydentist.co.in/">Dental</a></li>
      ...
      <div class="footer-middle">
        <div class="container">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 	      ...
 	      <p>&copy; Copyright 2019 <a href="medical-stores.php">Medilife</a></p>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      ...
      <div class="footer-bottom">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <p>Design & Developed By <a rel="nofollow" href="medical-stores.php">Medilife</a></p>
            </div>
          </div>
        </div>
      </div>
